<div class="row">
    ...
    <div class="col-md-6">
        ...
        <a href="https://wa.me/?text={{ urlencode('Cek postingan ini di Instagram: ' . $media['permalink']) }}" target="_blank" class="btn btn-sm mt-3" style="background-color: #114A43; color: #fff">Bagikan ke WhatsApp</a>
    </div>
</div>
