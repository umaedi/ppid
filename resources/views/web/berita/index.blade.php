...
<script type="text/javascript">
        ...
        for (let i = 0; i < 4; i++) {
            ...
            <div class="col-6 mb-3"> 
                <div class="baru-news-item">
                    <div class="ph-item d-flex align-items-start">
                        <div class="ph-col-4">
                            <div class="ph-picture"></div> 
                        </div>
                        <div class="ph-col-8">
                            <div class="ph-row">
                                <div class="ph-col-12 mb-2"></div> 
                                <div class="ph-col-8 mb-1"></div> 
                                <div class="ph-col-4 empty"></div> 
                                <div class="ph-col-6 mb-1"></div> 
    ...
    // Tampilkan skeleton loader saat halaman dimuat
    document.addEventListener('DOMContentLoaded', function() {
        const container = document.querySelector('.baru-news-section');
        if (container) {
            container.innerHTML = `
            <div class="row">
                ${make_skeleton()}
