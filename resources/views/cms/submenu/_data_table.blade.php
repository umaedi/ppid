...
<tr>
    ...
    <td>{{ $tb->nama_submenu }}</td>
    <td>{{ $tb->link }}</td>
    <td>
        <button class="btn btn-sm btn-warning" onclick="updateSubmenu('{{ $tb->id }}', '{{ $tb->nama_submenu }}', '{{ $tb->link }}')">edit</button>
        <button class="btn btn-sm btn-danger" onclick="hapusSubmenu('{{ $tb->id }}')">hapus</button>
    </td>
</tr>
@empty
<tr>
