    ...
    <tbody>
        @forelse ($table as $key =>  $tb)
            <tr>
                ...
                <td><span
                        class="badge {{ $tb->status == 'publish' ? 'bg-primary' : 'bg-warning' }}">{{ $tb->status }}</span>
                </td>
                <td style="width: 150px">
                    <a href="/halaman/{{ $tb->slug }}" target="_blank" class="badge bg-primary"><i
                            class='bx bx-show'></i></a>
                    <a href="/cms/halaman/edit/{{ $tb->id }}" class="badge bg-warning"><i
                            class='bx bxs-edit'></i></a>
                    <span class="badge bg-danger" onclick="hapusHalaman('{{ $tb->id }}')"><i
