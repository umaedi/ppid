...
<div class="container-xxl flex-grow-1 container-p-y">
  <div class="card">
    ...
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('cms-fasilitas-create', [config('services.subdomain')]) }}" class="btn btn-primary">
...
// Load data fasilitas via AJAX
function loadTable() {
    let url = '{{ route("cms-fasilitas", ['subdomain' => config('services.subdomain')]) }}';
...
$(document).on('click', '.btn-hapus', function() {
    ...
    swal({
        ...
        if (confirmDelete) {
            let url = '{{ route("cms-fasilitas-delete", ["subdomain" => "__SUBDOMAIN__", "id" => "__ID__"]) }}'
            ...
            $.ajax({
                ...
                success: function(res) {
                    swal("Berhasil!", "Fasilitas telah dihapus.", "success")
                        .then(() => loadTable());
                },
                error: function(xhr) {
