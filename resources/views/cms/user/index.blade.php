            ...
            <div class="card-body">
                {{-- <form id="kategoriSubmit"> --}}
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label for="nama_domain">Pilih domain</label>
                                    <select name="nama_domain" id="nama_domain" class="form-control">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="input-group">
                                <select id="user" name="user_id" id="" class="form-control">
                                    <option value="">--pilih user--</option>
                                </select>
                                <input type="text" id="search-input" class="form-control" placeholder="cari nama user">
                              </div>
                        </div>
                    </div>
            ...
            if(e.which == 13) {
                ...
                await transAjax(param).then((result) => {
                    ...
                    if(data.length > 0) {
                        var html = "";
                            data.forEach(user => {
                            html += `<option value="${user.id}">${user.nama + ' (' + user.email + ')'}</option>`
                        });
                    }else {
