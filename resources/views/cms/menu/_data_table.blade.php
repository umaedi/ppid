...
<tr>
    ...
    <td>{{ $tb->link }}</td>
    <td>
        <a href="/cms/menu/submenu/{{ $tb->id }}" class="btn btn-sm btn-primary">submenu</a>
        <button class="btn btn-sm btn-warning" onclick="updateMenu('{{ $tb->id }}', '{{ $tb->nama_menu }}', '{{ $tb->link }}')">edit</button>
        <button class="btn btn-sm btn-danger" onclick="hapusMenu('{{ $tb->id }}')">hapus</button>
    </td>
</tr>
@empty
<tr>
