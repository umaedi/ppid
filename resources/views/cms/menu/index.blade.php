                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <small class="mt-1 d-block text-danger"id="error-nama_menu"></small>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
...
<script type="text/javascript">
        ...
        $("#formMenu").submit(async function(e) {
            ...
            if(id_menu) {
               var _url = '/cms/menu/update/'+id_menu;
            }else {
                var _url = '/cms/menu/store';
            }
        ...
        function updateMenu(id, nama_menu, link)
        {
            id_menu = id;
