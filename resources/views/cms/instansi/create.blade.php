      ...
      <div class="col-xl">
        <div class="card mb-4">
          <div class="card-header d-flex justify-content-between align-items-center">
            <h3 class="mb-0">Buat Instansi</h3>
            <a href="{{ route('cms-instansi', ['subdomain' => config('services.subdomain')]) }}" class="btn btn-primary"><i class='bx bx-arrow-back'></i> Kembali</a>            
          </div>
          <div class="card-body">
            <form id="submitinstansi" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
...
<script>
    $('#submitinstansi').submit(async function(e) {
        e.preventDefault();
        ...
        await $.ajax({
            url: '{{ route("cms-instansi-store", ['subdomain' => config('services.subdomain')]) }}',
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
